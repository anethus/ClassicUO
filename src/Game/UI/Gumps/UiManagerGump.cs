...
namespace ClassicUO.Game.UI.Gumps
{
    ...
    internal sealed class UiManagerGump: Gump
    {
        ...
        public UiManagerGump(): base(130, 130)
        {
            ...
            Add(new Label(ResGumps.UIManagerGumpX, true, HUE_FONT, 0, 255, Renderer.FontStyle.BlackBorder) { X = 300, Y = 10 });
            Add(new Label(ResGumps.UIManagerGumpY, true, HUE_FONT, 0, 255, Renderer.FontStyle.BlackBorder) { X = 340, Y = 10 });
